...
""" Function used to get the attributes of the picture and classify them """
def classify_picture(picture_path):
    ...
    if os.path.exists(img_dir):
        ...
        for imge in range(4005,4005+len(names)):
            ...
            for faceBox in faceBoxes:               
                ...
                # current temp solution: return the information of the first detected face
                return gender, age, detectedAttributeList
